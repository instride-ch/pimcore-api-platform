...
class ImageTypeFactory implements DataObjectFieldTypeMetadataFactoryInterface
{
    public function supports($classDefinition, Data $fieldDefinition): bool
    {
        return $fieldDefinition instanceof Data\Image;
    }
    ...
    public function create(
        ...
        $propertyMetadata = $propertyMetadata->withType(new Type(
