...
class DateTypeFactory implements DataObjectFieldTypeMetadataFactoryInterface
{
    public function supports($classDefinition, Data $fieldDefinition): bool
    {
        return $fieldDefinition instanceof Data\Date || $fieldDefinition instanceof Data\Datetime;
    }
    ...
    public function create(
        ...
        $propertyMetadata = $propertyMetadata->withType(new Type(Type::BUILTIN_TYPE_OBJECT, true, \DateTime::class));
