...
class InputTypeFactory implements DataObjectFieldTypeMetadataFactoryInterface
{
    ...
    public function create(
        ...
        $propertyMetadata = $propertyMetadata->withType(new Type(Type::BUILTIN_TYPE_STRING, true));
