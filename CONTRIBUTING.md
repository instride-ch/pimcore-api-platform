# Contributing to Pimcore API Platform

## Bug Reports & Feature Requests
The w-vision team heavily uses (and loves!) GitHub for all of our software management. 
We use GitHub issues exclusively to track all bugs and features.

* [Open an issue](https://github.com/w-vision/PimcoreApiPlatform/issues) here on GitHub. 
If you can, **please provide a fix and create a pull request (PR) instead**; this will automatically create an issue for you.
* Report security issues only to open-source@w-vision.ch 
* Please be patient as not all items will be tested immediately - remember, Pimcore API Platform is open source and free of charge. 
...
* [Open an issue](https://github.com/w-vision/PimcoreApiPlatform/issues) describing the problem that you are looking to solve in 
...
* **Project** - is an umbrella term that refers to any and all w-vision projects.
